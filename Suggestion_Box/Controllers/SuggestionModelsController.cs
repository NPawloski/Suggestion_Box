...
namespace Suggestion_Box.Controllers
{
    ...
    {
        private Suggestion_BoxContext db = new Suggestion_BoxContext();
        ...
        public ActionResult Create([Bind(Include = "ID,Comment,Topic")] SuggestionModel suggestionModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Comment,Topic")] SuggestionModel suggestionModel)
        {
            if (ModelState.IsValid)
            {
